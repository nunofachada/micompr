...
toLatex(mic,
        booktabs = T, labels_show_cmp = F, labels_show_col = F,
...
toLatex(mic,
        booktabs = T, labels_show_cmp = F,
        labels_show_col = F, tag_row_show = F,
...
toLatex(mic,
        ...
        data_show = c("parp-1", "parp-2", "sep",
                      "aparp-1", "aparp-2", "sep",
                      "varexp-1", "varexp-2"),
        data_labels = c("$t$-test 1", "$t$-test 1", "sep",
                      "$t$-test 1 (wb)", "$t$-test 2 (wb)", "sep",
                      "Var 1", "Var 2"),
